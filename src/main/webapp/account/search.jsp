                ...
                <div class="row">
                                            ...
                                            <div class="input-group">
                                                <div class="form-control">
                                                    ...
                                                    <select name="properties" id="properties" style="width: 120px">
                                                        <option value="Username" <c:if test='${properties == "Username"}'>selected="true" </c:if> >Username</option>
                                                        <option value="Permission" <c:if test='${properties == "Permission"}'>selected="true" </c:if> >Permission</option>
                                                    </select>
                                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mails m-0 table table-actions-bar table-centered">
                            ...
                            <tbody>
                            <c:forEach items='${requestScope["listAccountSearch"]}' var="account">
                                    ...
                                    <c:if test='${account.getIdUser() == staff.getId()}'>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-outline-waiting"
                                                        data-toggle="tooltip"
                                                ...
                                                <c:if test="${!account.isStatus()}">
                                                    <button type="button" class="btn btn-outline-info"
                                                            data-toggle="tooltip"
                                                            data-placement="top" title="Unlock Account">
