<div class="navbar-custom" >
    ...
    <!-- LOGO -->
    <div class="logo-box">
<%--        <img src="/assets/images/logo/coffee_chu.png" alt="" width="100%" height="100%">--%>
<%--        <a href="${pageContext.request.contextPath}/login" class="logo text-center logo-dark">--%>
<%--                        <span class="logo-lg">--%>
<%--                            <img src="/assets/images/logo/logo-coffee-2.png" alt="" height="26">--%>
<%--                            <!-- <span class="logo-lg-text-dark">Simple</span> -->--%>
<%--                        </span>--%>
<%--            <span class="logo-sm">--%>
<%--                            <!-- <span class="logo-lg-text-dark">S</span> -->--%>
<%--                            <img src="/assets/images/logo/logo-coffee-2.png" alt="" height="22">--%>
<%--                        </span>--%>
<%--        </a>--%>

<%--        <a href="index.html" class="logo text-center logo-light">--%>
<%--&lt;%&ndash;                        <span class="logo-lg">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <img src="/assets/images/logo/logo-coffee-2.png" alt="" height="26">&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <!-- <span class="logo-lg-text-light">Simple</span> -->&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </span>&ndash;%&gt;--%>
<%--            <span class="logo-sm">--%>
