<div class="left-side-menu">
    ...
    <div>
        <a href="${pageContext.request.contextPath}/login?action=home">
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu" id="side-menu">
            ...
            <c:if test='${accountLogin.getPermission()=="Admin"}'>
            <li>
                <a href="javascript: void(0);">
                    <i class="ti-paint-bucket"></i>
            ...
            <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    ...
                    <li><a href="${pageContext.request.contextPath}/staffs?action=list_inactive">All Staff Inactive</a>
                    </li>
                </ul>
            </li>
