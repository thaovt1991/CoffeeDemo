        ...
        <ul class="metismenu" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav-second-level" aria-expanded="false">
                    <li><a href="/staffs?action=create">Create New Staff</a></li>
                    <li><a href="/staffs?action=list">Show All Staff Active</a></li>
                    <li><a href="/staffs?action=list_inactive">Show All Staff Inactive</a></li>
